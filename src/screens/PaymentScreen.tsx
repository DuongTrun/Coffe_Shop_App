...
const PaymentList = [
  ...
  {
    name: 'Google Pay',
    icon: require('../assets/app_img/gpay.png'),
    isIcon: false,
  },
  {
    name: 'Apple Pay',
    icon: require('../assets/app_img/applepay.png'),
    isIcon: false,
  },
  {
    name: 'Amazon',
    icon: require('../assets/app_img/amazonpay.png'),
    isIcon: false,
  },
];
...
const PaymentScreen = ({navigation,route} : any) => {
  ...
  return (
    <View style={styles.ScreenConntainer} >
      ...
      {showAnimation
      ? <PopUpAnimation style={styles.LottieAnimatoin}
                ...
                : COLORS.primaryGreyHex,
                 ...
                 <View style={styles.CreditCardBG}>
                  <LinearGradient
                    ...
                    style={styles.LinearGradientsStyle}
                  ...
                  >
                    ...
                    <View style={styles.CreditCardNumberContainer}>
                      ...
                      <Text style={styles.CreditCardNumber}>6820</Text>
                      <Text style={styles.CreditCardNumber}>8925</Text>
